  ...
  return (
    <div className="max-w-3xl mx-auto py-8">
      ...
      <div className="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl overflow-hidden">
        <div className="bg-brand-700 px-6 py-8 sm:p-10">
          <div className="flex items-center gap-6">
            <div className="h-24 w-24 rounded-full bg-brand-900 text-white flex items-center justify-center font-bold text-4xl shadow-lg ring-2 ring-brand-600">
              CO
            </div>
            <div>
              <h3 className="text-2xl font-bold text-white">Usuario de Contabilidad</h3>
              <p className="text-brand-200 mt-1">Gestión Financiera</p>
            </div>
          </div>
        </div>
