    ...
    <div className="flex flex-col h-full bg-white rounded-lg shadow">
        ...
        {messages.map((msg) => {
          ...
          return (
            <div key={msg.MessageID} className={`flex flex-col ${isMe ? 'items-end' : 'items-start'}`}>
              ...
              <div className={`max-w-[70%] rounded-lg p-3 ${isMe ? 'bg-brand-500 text-white' : 'bg-gray-100 text-gray-800'}`}>
      ...
      <form onSubmit={handleSendMessage} className="p-4 border-t flex flex-col gap-2">
        ...
        <div className="flex gap-2 items-center">
          <label className="cursor-pointer p-2 text-gray-500 hover:text-brand-500 hover:bg-gray-100 rounded-full">
          ...
          <input
            ...
            className="flex-1 border rounded-full px-4 py-2 focus:outline-none focus:ring-2 focus:ring-brand-500"
            disabled={uploading}
          />
          ...
          <button 
            ...
            className="bg-brand-500 text-white p-2 rounded-full disabled:opacity-50 hover:bg-brand-600 transition"
          >
