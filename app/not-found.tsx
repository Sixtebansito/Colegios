  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="max-w-lg w-full bg-white rounded-2xl shadow-xl p-8 sm:p-12 text-center">
        ...
        <Link 
          href="/" 
          className="inline-flex items-center justify-center w-full sm:w-auto px-8 py-3 bg-[#111827] text-white font-medium rounded-lg hover:bg-[#1f2937] transition-colors shadow-sm hover:shadow-md"
        >
          Volver al Inicio
        </Link>
      </div>
